const scriptURL =
  "https://script.google.com/macros/s/AKfycbwQk_s9MEqVnxDy8L9O0TD0rZH9-26r1NA_JtVSZjJn5KeN5nhSS5MPT5AikwEcs6eXGQ/exec";
...
const moreWork4 = document.querySelector(".more-work4");
const moreWork5 = document.querySelector(".more-work5");
...
function otherWork(e) {
  ...
  moreWork4.style.display = "block";
  moreWork5.style.display = "block";
  if (moreBtn.innerText === "More Projects") {
    ...
    moreWork4.style.display = "none";
    moreWork5.style.display = "none";
  }
}
